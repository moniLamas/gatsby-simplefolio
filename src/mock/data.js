...
export const aboutData = {
  ...
  paragraphThree: 'Os dejo el link para descargar mi cv. Y en la siguiente sección muestro algunos de los proyectos en lo que realice la maquetación, corrección de textos y tratamiento de imágenes.',
